#include "vtkExtractMidsurfacePlus.h"
...
vtkStandardNewMacro(vtkExtractMidsurfacePlus);

//----------------------------------------------------------------------------
vtkExtractMidsurfacePlus::vtkExtractMidsurfacePlus() : InputArray(nullptr)
{
	vtkVLog(PARAVIEW_LOG_PLUGIN_VERBOSITY(), "vtkExtractMidsurfacePlus::vtkExtractMidsurfacePlus() BEGIN");

	this->SetNumberOfInputPorts(1);
	this->SetNumberOfOutputPorts(1);

	vtkVLog(PARAVIEW_LOG_PLUGIN_VERBOSITY(), "vtkExtractMidsurfacePlus::vtkExtractMidsurfacePlus() END");
}

vtkExtractMidsurfacePlus::~vtkExtractMidsurfacePlus()
{
	vtkVLog(PARAVIEW_LOG_PLUGIN_VERBOSITY(), "vtkExtractMidsurfacePlus::~vtkExtractMidsurfacePlus() BEGIN");
...
int vtkExtractMidsurfacePlus::FillOutputPortInformation(int, vtkInformation *info)
{
	vtkVLog(PARAVIEW_LOG_PLUGIN_VERBOSITY(), "vtkExtractMidsurfacePlus::FillOutputPortInformation() BEGIN");

	info->Set(vtkDataObject::DATA_TYPE_NAME(), "vtkPolyData");

	vtkVLog(PARAVIEW_LOG_PLUGIN_VERBOSITY(), "vtkExtractMidsurfacePlus::FillOutputPortInformation() END");

	return 1;
}

int vtkExtractMidsurfacePlus::RequestInformation(vtkInformation *vtkNotUsed(request), vtkInformationVector **inputVector, vtkInformationVector *outputVector)
{
...
int vtkExtractMidsurfacePlus::RequestData(vtkInformation *vtkNotUsed(request),
										  vtkInformationVector **inputVector,
										  vtkInformationVector *outputVector)
{
	vtkVLog(PARAVIEW_LOG_PLUGIN_VERBOSITY(), "vtkExtractMidsurfacePlus::RequestData() BEGIN");
	...
	vtkVLog(PARAVIEW_LOG_PLUGIN_VERBOSITY(), "vtkExtractMidsurfacePlus::RequestData() END");
...
void vtkExtractMidsurfacePlus::ComputeGaussianSmoothing(vtkImageData *image)
{
